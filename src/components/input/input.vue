<template>
    <div :class="wrapClasses">
        <template v-if="type !== 'textarea'">
            ...
            <i class="mep-icon" :class="['mep-icon-' + icon, prefixCls + '-icon']" v-if="icon" @click="handleIconClick"></i>
            <transition name="fade">
                <i class="mep-icon mep-icon-load-c mep-load-loop" :class="[prefixCls + '-icon', prefixCls + '-icon-validate']" v-if="!icon"></i>
            </transition>
            <input
                :type="type"
                :class="inputClasses"
